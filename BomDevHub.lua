...
local DISCORD_LINK = "https://discord.gg/bakbom"
...
local ACCENT2 = Color3.fromRGB(60, 180, 255)
...
gradient(MainFrame, Color3.fromRGB(12, 10, 20), Color3.fromRGB(8, 8, 14), 135)
...
task.spawn(function()
    task.wait(0.5)
    notify("BomDev Hub", "Loaded - by BakBom  |  ] to toggle", 4)
end)
