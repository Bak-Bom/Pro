...
local function toggleCustomCrosshair(state)
    ...
    local lines = {
        {UDim2.new(0, 15, 0, 2), UDim2.new(0.5, 8, 0.5, -1)},
        {UDim2.new(0, 15, 0, 2), UDim2.new(0.5, -23, 0.5, -1)},
        {UDim2.new(0, 2, 0, 15), UDim2.new(0.5, -1, 0.5, 8)},
        {UDim2.new(0, 2, 0, 15), UDim2.new(0.5, -1, 0.5, -23)},
    }
            ...
            if hrp then
                for _, v in ipairs(hrp:GetChildren()) do
                    if v:IsA("BodyVelocity") then
                        v.MaxForce = Vector3.new(4e4, 4e4, 4e4)
                    end
                end
            end
        end)
